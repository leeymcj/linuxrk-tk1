...
{
	sys_call_table[__NR_rk_resource_set_create]		= sys_call_table[0];
	sys_call_table[__NR_rk_resource_set_destroy]		= sys_call_table[0];
	sys_call_table[__NR_rk_cpu_reserve_create]		= sys_call_table[0];
	sys_call_table[__NR_rt_wait_for_next_period]		= sys_call_table[0];
	sys_call_table[__NR_rk_setschedulingpolicy]		= sys_call_table[0];
	sys_call_table[__NR_rk_resource_set_attach_process]	= sys_call_table[0]; 
	sys_call_table[__NR_rk_get_start_of_current_period]	= sys_call_table[0];
	sys_call_table[__NR_rk_get_current_time]		= sys_call_table[0];
	sys_call_table[__NR_rk_is_scheduling]			= sys_call_table[0];
	sys_call_table[__NR_rk_resource_set_detach_process]	= sys_call_table[0];
	sys_call_table[__NR_rk_pip_mutex]			= sys_call_table[0]; 
	sys_call_table[__NR_rk_pcp_mutex]			= sys_call_table[0]; 
	sys_call_table[__NR_rk_hlp_mutex]			= sys_call_table[0]; 
	sys_call_table[__NR_rk_mpcp_mutex]			= sys_call_table[0]; 
	sys_call_table[__NR_rk_vmpcp_mutex]			= sys_call_table[0]; 
	sys_call_table[__NR_rk_vmpcp_intervm_mutex]		= sys_call_table[0]; 
	sys_call_table[__NR_rk_getcpursv_prev_used_ticks]	= sys_call_table[0];
	sys_call_table[__NR_rk_getcpursv_min_utilization]	= sys_call_table[0];
	sys_call_table[__NR_rk_getcpursv_max_utilization]	= sys_call_table[0];
	sys_call_table[__NR_rk_getcpursv_profile]		= sys_call_table[0];
#ifdef CONFIG_RK_MEM
	sys_call_table[__NR_rk_mem_reserve_create]		= sys_call_table[0];
	sys_call_table[__NR_rk_mem_reserve_delete]		= sys_call_table[0];
	sys_call_table[__NR_rk_mem_reserve_eviction_lock]	= sys_call_table[0];
#endif
	sys_call_table[__NR_rk_trace]				= sys_call_table[0]; 
	sys_call_table[__NR_rk_get_start_of_next_vcpu_period]	= sys_call_table[0]; 
	sys_call_table[__NR_rk_vchannel]			= sys_call_table[0]; 
...
MODULE_DESCRIPTION("RK Module Version 1.0");
MODULE_LICENSE("GPL");
