 ...
 *
 * - RK_MEM_COLORING: Enable cache/bank coloring (CONFIG_RK_MEM needed)
 ...
 *      Cache/Bank coloring experiment: RK_TRACE, RK_TRACE_SUM, RK_PROFILE_PMC, RK_MEM_COLORING
 */
...
#define RK_MEM_COLORING
#define RK_MEM_NO_SWAP // For systems with no swap partition (i.e. ARM odroid)
//#define RK_VIRT_SUPPORT

#if defined(RK_PROFILE_PMC) || defined(RK_MEM_COLORING)
	//#define RK_X86_SANDYBRIDGE	// i.e. Intel Core i7 2600, i5 2540
